...
const styles = StyleSheet.create({
  ...
  // Style Airbnb : Remplacement du gros badge rouge par une pastille épurée sur l'avatar et du texte en gras
  unreadDot: { 
    position: 'absolute', 
    top: 0, 
    right: 0, 
    backgroundColor: COLORS.blumine[600], // Utilise ta couleur pro principale ou '#FF385C' pour le rouge Airbnb original
    width: 14, 
    height: 14, 
    borderRadius: 7,
    borderWidth: 2,
  ...
  // Style d'écran vide à la Airbnb (épuré avec un cercle léger)
  emptyContainer: { 
    flex: 1,
