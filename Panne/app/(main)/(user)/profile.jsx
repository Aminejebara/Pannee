...
export default function UserProfile() {
  ...
  const loadProfile = async () => {
    ...
    if (result.success) {
      ...
      setLocalAvatar(userData.avatar_url)
    }
  }
  ...
  onPress={() => router.push('/(main)/(user)/help')}  // ✅ BON
  noBorder 
/>
          </View>
...
// Composants internes identiques au style Pro
