...
INSERT INTO `admins` VALUES (1,'super_admin','admin@panne.com','$2y$10$YourHashedPasswordHere','Super Administrateur','super_admin','https://picsum.photos/id/64/200/200',NULL,1,'2026-04-09 14:59:34','2026-04-09 14:59:34');
...
INSERT INTO `professional_categories` VALUES (9,1),(9,2),(6,3),(9,3),(9,4),(9,5),(9,6),(9,8),(9,9),(9,10);
...
INSERT INTO `professionals` VALUES (6,17,'Aminecompany','exemple','manouba',NULL,NULL,'tunis','Tunisie','active',0,4.00,3,'2026-04-06 17:35:56','2026-04-09 14:43:32'),(9,20,'MEDICAR','medicar fait pour remplacer les pneu des voitures de vos mere','',55.8164642,20.0905532,'','','pending',0,0.00,0,'2026-04-09 15:42:04','2026-04-10 18:05:05');
...
INSERT INTO `refresh_tokens` VALUES (25,5,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NSwiZW1haWwiOiJyYXdlbmFiZGVsaTQwQGdtYWlsLmNvbSIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzc1NDY2MzE4LCJleHAiOjE3NzYwNzExMTh9.72jHFv6dJ3pJTUllQCI6wO7dWe-44ObRZH6mUiuucok',0,'2026-04-13 09:05:18','2026-04-06 09:05:18'),(51,17,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTcsImVtYWlsIjoiYW1pbmViZW5qZWJhcmE1QGdtYWlsLmNvbSIsInJvbGUiOiJwcm9mZXNzaW9uYWwiLCJpYXQiOjE3NzU3NDU2NTMsImV4cCI6MTc3NjM1MDQ1M30.9q5LSBgX-lnzjB3pbuuorTjaZDjv0zh5nVKWmLRXkoE',0,'2026-04-16 14:40:53','2026-04-09 14:40:53'),(54,16,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTYsImVtYWlsIjoic3F1YWJvaTUwMDBAZ21haWwuY29tIiwicm9sZSI6InVzZXIiLCJpYXQiOjE3NzU3NDc3NTMsImV4cCI6MTc3NjM1MjU1M30.JnCRfbING9cWqemjAs4MZhmgNp0bHmTQVJVpV_9Wbcs',0,'2026-04-16 15:15:53','2026-04-09 15:15:53'),(69,22,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjIsImVtYWlsIjoibmF3cmVzLjEyNWJlamlAZ21haWwuY29tIiwicm9sZSI6InVzZXIiLCJpYXQiOjE3NzU4NDExNTEsImV4cCI6MTc3NjQ0NTk1MX0.9YaPxlt2YNvRJvVjRtBR3zGXEotlh0A-5cxbLxFgMYY',0,'2026-04-17 17:12:31','2026-04-10 17:12:31'),(71,20,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsImVtYWlsIjoicmF3ZW5hYmRlbGk1QGdtYWlsLmNvbSIsInJvbGUiOiJwcm9mZXNzaW9uYWwiLCJpYXQiOjE3NzU4NDQyOTIsImV4cCI6MTc3NjQ0OTA5Mn0.dzlItAQ-vid9XsAq1OkW05WNyv_SivmUxU0ysRc5VQc',0,'2026-04-17 18:04:52','2026-04-10 18:04:52');
...
INSERT INTO `service_categories` VALUES (1,'Mécanique','mecanique','flash'),(2,'Électricité Auto','electricite-auto','flash'),(3,'Ambulance','ambulance','flash'),(4,'Location Auto','location-auto','flash'),(5,'Pneumatique','pneu','flash'),(6,'Bornes Électriques','bornes-elec','flash'),(8,'Lavage Auto','lavage-auto','flash'),(9,'Batterie','flashflash','flash'),(10,'Diagnostic','diagnostic','flash');
...
CREATE TABLE `sponsors` (
  ...
  CONSTRAINT `fk_sponsor_admin` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sponsors` VALUES (5,1,'TechCorp Solutions','https://www.techcorp.com','https://i.ytimg.com/vi/LcLNHDKoYF4/maxresdefault.jpg','https://picsum.photos/id/0/200/100','home_top','active',10,'2023-12-31 23:00:00','2024-12-31 22:59:59',1523,45200,'2026-04-09 15:00:17','2026-04-09 15:08:13'),(9,1,'TechCorp Solutions','https://www.techcorp.com','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRne_DozbFUvzIfPD1Spu2IpjBkT64F3h_8Mw&s','https://www.google.com/imgres?q=publicite%20coca%20cola&imgurl=https%3A%2F%2Fwww.creads.com%2Fwp-content%2Fuploads%2F2021%2F05%2Fcoca-cola-1.jpg&imgrefurl=https%3A%2F%2Fwww.creads.com%2Fblog%2Fdecryptage%2Fanalyses-marketing-communication%2Fpublicite-coca-cola-dessine-le-pere-noel-en-1931%2F&docid=aSEtd3AM8hLHSM&tbnid=LVDO2kaHUxX3GM&vet=12ahUKEwiq6-nvheGTAxXEhf0HHbuXNMsQnPAOegQIEhAB..i&w=1536&h=1024&hcb=2&ved=2ahUKEwiq6-nvheGTAxXEhf0HHbuXNMsQnPAOegQIEhAB','home_top','active',10,'2023-12-31 23:00:00','2024-12-31 22:59:59',1523,45200,'2026-04-09 15:19:04','2026-04-09 15:20:30');
...
-- Dump completed on 2026-04-11 15:42:07
